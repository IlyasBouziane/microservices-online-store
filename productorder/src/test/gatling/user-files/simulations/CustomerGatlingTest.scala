...
class CustomerGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Customer entity")
        ...
        .repeat(2) {
            ...
            .get("/services/productorder/api/customers")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new customer")
            .post("/services/productorder/api/customers")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "userId":"0"
            ...
            .repeat(5) {
                ...
                .get("/services/productorder${new_customer_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created customer")
            .delete("/services/productorder${new_customer_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
