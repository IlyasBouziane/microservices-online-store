...
class ProductGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Product entity")
        ...
        .repeat(2) {
            ...
            .get("/services/productorder/api/products")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new product")
            .post("/services/productorder/api/products")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "sku":"SAMPLE_TEXT"
                , "upc":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/productorder${new_product_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created product")
            .delete("/services/productorder${new_product_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
