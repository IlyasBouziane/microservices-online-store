...
import com.bouziane_ilyas.store.domain.enumeration.Gender;
...
class CustomerResourceIT {
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.userId(UPDATED_USER_ID).email(UPDATED_EMAIL).addressLine2(UPDATED_ADDRESS_LINE_2).city(UPDATED_CITY);
